...
import fit.magic.cv.OverlayView;
import fit.magic.cv.R;
import fit.magic.cv.exercise_info.ExerciseInfoView;
...
public final class FragmentCameraBinding implements ViewBinding {
  ...
  @NonNull
  public final ExerciseInfoView exerciseInfoView;
  ...
  private FragmentCameraBinding(@NonNull CoordinatorLayout rootView,
      ...
      @NonNull ExerciseInfoView exerciseInfoView, @NonNull OverlayView overlay,
      @NonNull PreviewView viewFinder) {
    this.rootView = rootView;
    this.bottomSheetLayout = bottomSheetLayout;
    this.cameraContainer = cameraContainer;
    this.exerciseInfoView = exerciseInfoView;
  ...
  public static FragmentCameraBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.exercise_info_view;
      ExerciseInfoView exerciseInfoView = ViewBindings.findChildViewById(rootView, id);
      if (exerciseInfoView == null) {
        break missingId;
      }
      ...
      return new FragmentCameraBinding((CoordinatorLayout) rootView, binding_bottomSheetLayout,
          cameraContainer, exerciseInfoView, overlay, viewFinder);
    }
